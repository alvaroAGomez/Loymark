  ...
  },
  {
    ...
    children: [
      ...
      }, */
      {
        path: 'Actividades',
        loadChildren: () =>
          import('./views/actividades/actividades.module').then((m) => m.ActividadesModule)
      },
      {
        path: 'Usuarios',
        loadChildren: () =>
...
/*   { 
  ...
  { path: 'Actividades', loadChildren: () => import('./views/actividades/actividades.module').then(m => m.ActividadesModule) },
